...
Além disso, com esta dissertação foi possível validar a superioridade de precisão no uso da YOLOv8 para o conjunto de imagens coletadas em subestações de energia por meio de VANTs, em relação a suas últimas versões. Isso confirma a extrapolação feita a partir do trabalho de \cite{ultralytics2023yolo}, para o conjunto de dados aqui apresentado. Evidentemente, esse estudo também demonstra que todas as versões da YOLO que aqui foram testadas, mostraram resultados promissores, sendo possíveis candidatos para utilização destas redes, caso necessário. 
