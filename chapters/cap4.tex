...
De todo o conjunto de fotos coletadas, apenas 411 fotos foram selecionadas para serem processadas na RNC. Além disso, destas, 60\% foram alocadas para o conjunto de treinamento, enquanto 20\% para os conjuntos de teste e 20\% de validação. De acordo com \cite{itsmeSamrat2024}, esta forma de divisão do conjunto de imagens produz resultados mais parciais do que uma divisão que preconiza um conjunto de validação e de teste menor.
