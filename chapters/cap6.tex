...
\subsection{Resultados e comparação do treinamento com a YOLOv5 a YOLOv7}
...
Por isso, por configuração padrão da rede neural YOLO, entende-se a utilização do otimizador AdamW; com a taxa de aprendizado de 0,01; e configuração padrão de entrada das imagens de 640x640. 
